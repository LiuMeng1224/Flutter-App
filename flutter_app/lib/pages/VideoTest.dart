              ...
              Column(
                children: <Widget>[
                  ...
                  Stack(
                      ...
                      children: <Widget>[
                        _ButterFlyAssetVideo(),
                        Image.network('https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1593765204470&di=c18e1fe1af823aaf860fad29ccae376d&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fimages%2F20171113%2Fa79a543ee61f44f1b7746dbff4e0bf4a.jpeg',
                        height: 100,),
                      ]),
                ],
              ),
...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/audio/Butterfly-209.mp4');
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  Future<ClosedCaptionFile> _loadCaptions() async {
    final String fileContents = await DefaultAssetBundle.of(context)
        .loadString('assets/audio/bumble_bee_captions.srt');
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/audio/Butterfly-209.mp4');
